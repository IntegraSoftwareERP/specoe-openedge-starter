import { createRequire as __specoeCreateRequire } from 'node:module';
const require = __specoeCreateRequire(import.meta.url);
...
// entry-fastest-levenshtein.mjs
var import_fastest_levenshtein = __toESM(require_mod(), 1);
var export_closest = import_fastest_levenshtein.closest;
var export_distance = import_fastest_levenshtein.distance;
export {
  export_closest as closest,
  export_distance as distance
};
